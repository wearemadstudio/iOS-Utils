...
open class ImageScrollView: UIScrollView {
    ...
    @objc public enum imageViewContentMode: Int {
        case aspectFill
        case aspectFit
        case widthFill
        case heightFill
    ...
    @objc open var imageContentMode: imageViewContentMode = .widthFill
    @objc open var initialOffset: Offset = .begining
    
    @objc public private(set) var zoomView: UIImageView? = nil
    
    var imageSize = CGSize.zero
    fileprivate var pointToCenterAfterResize = CGPoint.zero
